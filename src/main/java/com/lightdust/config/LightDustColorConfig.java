...
public class LightDustColorConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_BIOME_TINTS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CAVE_BIOME_TRIGGERS;
