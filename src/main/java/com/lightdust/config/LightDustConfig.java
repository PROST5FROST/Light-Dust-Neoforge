...
public class LightDustConfig {
    ...
    // Handheld lights
    public static final ModConfigSpec.BooleanValue ENABLE_HANDHELD_LIGHTS;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> HANDHELD_LIGHT_ITEMS;
